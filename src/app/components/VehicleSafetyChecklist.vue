    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-3 gap-4 bg-gray-50 p-4 rounded-lg">
        <div>
          ...
          <p class="text-[13px] font-semibold text-gray-900">TRP-7891</p>
        </div>
        <div>
          <p class="text-[10px] text-gray-600 uppercase">Vehicle Number</p>
          <p class="text-[13px] font-semibold text-gray-900">KA-51-MN-2347</p>
        </div>
        <div>
          <p class="text-[10px] text-gray-600 uppercase">Inspection Date</p>
          <p class="text-[13px] font-semibold text-gray-900">December 17, 2024 • 06:30 AM</p>
        </div>
        <div>
          <p class="text-[10px] text-gray-600 uppercase">Driver Name</p>
          <p class="text-[13px] font-semibold text-gray-900">Rajesh Kumar</p>
        </div>
        <div>
          <p class="text-[10px] text-gray-600 uppercase">Vehicle Type</p>
          <p class="text-[13px] font-semibold text-gray-900">24 Feet Closed Body Truck</p>
        </div>
        <div>
          <p class="text-[10px] text-gray-600 uppercase">Route</p>
          <p class="text-[13px] font-semibold text-gray-900">Bangalore → Chennai</p>
        </div>
      </div>
      ...
      <div class="grid grid-cols-2 gap-4">
        <div class="border border-gray-300 rounded-lg p-4">
          ...
          <p class="text-[16px] font-bold text-gray-900">47,852 KM</p>
        </div>
        <div class="border border-gray-300 rounded-lg p-4">
          <p class="text-[10px] text-gray-600 uppercase mb-1">Next Service Due</p>
          <p class="text-[16px] font-bold text-orange-600">50,000 KM</p>
        </div>
      </div>
      ...
      <div class="grid grid-cols-2 gap-6 pt-4">
        <div class="border-t-2 border-gray-300 pt-3">
          ...
          <p class="text-[9px] text-gray-600 mt-1">Rajesh Kumar</p>
          <p class="text-[9px] text-gray-500">Date: December 17, 2024 • Time: 06:45 AM</p>
        </div>
        <div class="border-t-2 border-gray-300 pt-3">
          <p class="text-[11px] text-gray-900 font-semibold">Inspector Signature</p>
          <p class="text-[9px] text-gray-600 mt-1">Suresh Sharma (Operations Supervisor)</p>
          <p class="text-[9px] text-gray-500">Date: December 17, 2024 • Time: 06:45 AM</p>
        </div>
      </div>
